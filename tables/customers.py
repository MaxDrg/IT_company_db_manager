...
class Customers(BoxLayout):
    def __init__(self, app):
        ...
        if self.db.success_connection:
            row_data = self.db.get_customers()

        self.orientation = 'vertical'

        header = BoxLayout(padding=8, size_hint=(1, 0.1), orientation = 'vertical', spacing=10)

        page_name = Label(text='Customers', color='black', font_size=25)
        head_btn = Button(text="Find customer by phone", size_hint=(0.95, 1.5), pos_hint={"center_y": 0.5, "center_x": 0.5})
        ...
        self.table = MDDataTable(
            ...
            size_hint=(0.95, 0.5),
            column_data=[('ID', dp(20)), ('Name', dp(25)), ('Cooperation started', dp(35)), ('Owner', dp(35)), ('Contact', dp(35))],
            rows_num=50,
            row_data=row_data,
        )
        self.table.bind(on_check_press=self.checked)

        left = Button(text="Projects")
        ...
        right = Button(text="Employees", pos =(20, 20))
    ...
    def update(self, instance):
        ...
        self.table.row_data = self.db.get_customers()
    ...
    def add(self, instance):
        ...
        self.__app.screen_manager.current = 'add_customer'

    def dialog_input_show(self, instance):
        input_phone = BoxLayout(padding=10, orientation = 'vertical', size_hint_y=None)
        self.nummer = MDTextField(hint_text="Phone nummer")
        input_phone.add_widget(self.nummer)

        self.dialog = MDDialog(
            title="Find customer",
            type="custom",
            content_cls=input_phone,
            buttons=[
                MDFlatButton(
    ...
    def find_phone(self, instance):
        self.dialog.dismiss()
        self.checked_data = []
        self.table.row_data = self.db.get_customers_by_phone(self.nummer.text)
