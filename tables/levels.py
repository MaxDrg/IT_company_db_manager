...
class Levels(BoxLayout):
    def __init__(self, app):
        ...
        head_btn = Button(text="Update salary", size_hint=(0.95, 1.5), pos_hint={"center_y": 0.5, "center_x": 0.5})
        ...
        self.table = MDDataTable(
            ...
            size_hint=(0.95, 0.5),
            column_data=[('ID', dp(30)), ('Level name', dp(50)), ('Salary', dp(50))],
            rows_num=50,
            row_data=row_data,
        )
        self.table.bind(on_check_press=self.checked)

        left = Button(text="Employees")
        ...
        right = Button(text="Tasks", pos =(20, 20))
    ...
    def update(self, instance):
        ...
        self.table.row_data = self.db.get_levels()
    ...
    def add(self, instance):
        ...
        self.__app.screen_manager.current = 'add_level'

    def dialog_input_show(self, instance):
        input_phone = BoxLayout(padding=10, orientation = 'vertical', size_hint_y=None)
        self.new_salary = MDTextField(hint_text="New salary")
        input_phone.add_widget(self.new_salary)

        self.dialog = MDDialog(
            title="Updating salary",
            type="custom",
            ...
            buttons=[
                ...
                MDFlatButton(
                    text="OK", on_release = self.update_salary
                ),
            ],
        )
        self.dialog.open()

    def update_salary(self, instance):
        self.dialog.dismiss()
        for id in self.checked_data:
            self.db.update_salary(int(self.new_salary.text), id)
        self.checked_data = []
        self.table.row_data = self.db.get_levels()
